...
# Algorithm
- Start
- Create a new linked list dummy, and a node tail to point to the start of the linked list and to use for traversal
- Use an integer variable carry to calculate carry over
- Now loop through the list until one of the Listnode is not null (i.e.) still has numbers or if the carry is not 0
